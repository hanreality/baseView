...
open class AdvancedTextView @JvmOverloads constructor(
    ...
    fun initStyle(context: Context, attrs: AttributeSet?) {
        ...
        val compoundDrawables = generateCompoundDrawables(this, a)
    ...
    private fun generateCompoundDrawable(
        ...
        val drawable =
            if (pressedDrawable != null || selectedDrawable != null || disableDrawable != null) {
                ...
                drawable.addState(DrawableUtil.STATE_PRESSED, pressedDrawable)
                drawable.addState(DrawableUtil.STATE_SELECTED, selectedDrawable)
                drawable.addState(DrawableUtil.STATE_DISABLED, disableDrawable)
                drawable.addState(DrawableUtil.STATE_EMPTY, compoundDrawable)
                drawable
            } else {
                compoundDrawable
            }
