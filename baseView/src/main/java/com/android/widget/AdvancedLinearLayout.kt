...
open class AdvancedLinearLayout @JvmOverloads constructor(
    context: Context,
    ...
    fun initStyle(context: Context, attrs: AttributeSet?) {
        val a = context.obtainStyledAttributes(attrs, R.styleable.AdvancedLinearLayout)
    ...
    private fun generateDrawable(
        @NonNull widget: View,
        @NonNull params: AdvancedParams): GradientDrawable? {
    ...
    class AdvancedParams {
        ...
        companion object {
            fun newParams(a: TypedArray): AdvancedParams {
                ...
                params.mBorderWidth =
                    a.getDimensionPixelSize(R.styleable.AdvancedLinearLayout_border_width, 0)
                params.mBorderRadius =
                    a.getDimensionPixelSize(R.styleable.AdvancedLinearLayout_border_radius, 0)
                params.mBorderColor = a.getColor(R.styleable.AdvancedLinearLayout_border_color, -0x1)
                params.mGradientDirection =
                    a.getInt(R.styleable.AdvancedLinearLayout_gradient_direction, 0)
                params.mGradientStartColor =
                    a.getColor(R.styleable.AdvancedLinearLayout_gradient_startColor, -0x1)
                params.mGradientColors.add(params.mGradientStartColor)
                if (a.hasValue(R.styleable.AdvancedLinearLayout_gradient_centerColor)) {
                    params.mGradientCenterColor =
                        a.getColor(
                            R.styleable.AdvancedLinearLayout_gradient_centerColor,
                            -0x1
                        )
                    params.mGradientColors.add(params.mGradientCenterColor)
                }
                params.mGradientEndColor =
                    a.getColor(R.styleable.AdvancedLinearLayout_gradient_endColor, -0x1)
            ...
            fun newDisableParams(a: TypedArray): AdvancedParams {
                val params = AdvancedParams()
                params.mBorderWidth =
                    a.getDimensionPixelSize(R.styleable.AdvancedLinearLayout_disable_border_width, 0)
                params.mBorderRadius =
                    a.getDimensionPixelSize(R.styleable.AdvancedLinearLayout_disable_border_radius, 0)
                params.mBorderColor =
                    a.getColor(R.styleable.AdvancedLinearLayout_disable_border_color, -0x1)
                params.mGradientDirection =
                    a.getInt(R.styleable.AdvancedLinearLayout_disable_gradient_direction, 0)
                params.mGradientStartColor =
                    a.getColor(R.styleable.AdvancedLinearLayout_disable_gradient_startColor, -0x1)
                params.mGradientColors.add(params.mGradientStartColor)
                if (a.hasValue(R.styleable.AdvancedLinearLayout_disable_gradient_centerColor)) {
                    params.mGradientCenterColor =
                        a.getColor(
                            R.styleable.AdvancedLinearLayout_disable_gradient_centerColor,
                            -0x1
                        )
                    params.mGradientColors.add(params.mGradientCenterColor)
                }
                params.mGradientEndColor =
                    a.getColor(R.styleable.AdvancedLinearLayout_disable_gradient_endColor, -0x1)
                params.mGradientColors.add(params.mGradientEndColor)
                params.mDisableColor = a.getColor(R.styleable.AdvancedLinearLayout_disable_color, 1)
                params.mBorderRadiusTopLeft = a.getDimensionPixelSize(
                    R.styleable.AdvancedLinearLayout_disable_border_radius_top_left,
                    0
                )
                params.mBorderRadiusTopRight = a.getDimensionPixelSize(
                    R.styleable.AdvancedLinearLayout_disable_border_radius_top_right,
                    0
                )
                params.mBorderRadiusBottomLeft = a.getDimensionPixelSize(
                    R.styleable.AdvancedLinearLayout_disable_border_radius_bottom_left,
                    0
                )
                params.mBorderRadiusBottomRight = a.getDimensionPixelSize(
                    R.styleable.AdvancedLinearLayout_disable_border_radius_bottom_right,
                    0
                )
                return params
            }
            ...
            fun newSelectedParams(a: TypedArray): AdvancedParams {
                val params = AdvancedParams()
                params.mBorderWidth =
                    a.getDimensionPixelSize(R.styleable.AdvancedLinearLayout_selected_border_width, 0)
                params.mBorderRadius =
                    a.getDimensionPixelSize(R.styleable.AdvancedLinearLayout_selected_border_radius, 0)
                params.mBorderColor =
                    a.getColor(R.styleable.AdvancedLinearLayout_selected_border_color, -0x1)
                params.mGradientDirection =
                    a.getInt(R.styleable.AdvancedLinearLayout_selected_gradient_direction, 0)
                params.mGradientStartColor =
                    a.getColor(R.styleable.AdvancedLinearLayout_selected_gradient_startColor, -0x1)
                params.mGradientColors.add(params.mGradientStartColor)
                if (a.hasValue(R.styleable.AdvancedLinearLayout_selected_gradient_centerColor)) {
                    params.mGradientCenterColor =
                        a.getColor(
                            R.styleable.AdvancedLinearLayout_selected_gradient_centerColor,
                            -0x1
                        )
                    params.mGradientColors.add(params.mGradientCenterColor)
                }
                params.mGradientEndColor =
                    a.getColor(R.styleable.AdvancedLinearLayout_selected_gradient_endColor, -0x1)
                params.mGradientColors.add(params.mGradientEndColor)
                params.mSelectedColor = a.getColor(R.styleable.AdvancedLinearLayout_selected_color, 1)
                params.mBorderRadiusTopLeft = a.getDimensionPixelSize(
                    R.styleable.AdvancedLinearLayout_selected_border_radius_top_left,
                    0
                )
                params.mBorderRadiusTopRight = a.getDimensionPixelSize(
                    R.styleable.AdvancedLinearLayout_selected_border_radius_top_right,
                    0
                )
                params.mBorderRadiusBottomLeft = a.getDimensionPixelSize(
                    R.styleable.AdvancedLinearLayout_selected_border_radius_bottom_left,
                    0
                )
                params.mBorderRadiusBottomRight = a.getDimensionPixelSize(
                    R.styleable.AdvancedLinearLayout_selected_border_radius_bottom_right,
                    0
                )
                return params
            }
            ...
            fun newPressedParams(a: TypedArray): AdvancedParams {
                val params = AdvancedParams()
                params.mBorderWidth =
                    a.getDimensionPixelSize(R.styleable.AdvancedLinearLayout_pressed_border_width, 0)
                params.mBorderRadius =
                    a.getDimensionPixelSize(R.styleable.AdvancedLinearLayout_pressed_border_radius, 0)
                params.mBorderColor =
                    a.getColor(R.styleable.AdvancedLinearLayout_pressed_border_color, -0x1)
                params.mGradientDirection =
                    a.getInt(R.styleable.AdvancedLinearLayout_pressed_gradient_direction, 0)
                params.mGradientStartColor =
                    a.getColor(R.styleable.AdvancedLinearLayout_pressed_gradient_startColor, -0x1)
                params.mGradientColors.add(params.mGradientStartColor)
                if (a.hasValue(R.styleable.AdvancedLinearLayout_pressed_gradient_centerColor)) {
                    params.mGradientCenterColor =
                        a.getColor(
                            R.styleable.AdvancedLinearLayout_pressed_gradient_centerColor,
                            -0x1
                        )
                    params.mGradientColors.add(params.mGradientCenterColor)
                }
                params.mGradientEndColor =
                    a.getColor(R.styleable.AdvancedLinearLayout_pressed_gradient_endColor, -0x1)
                params.mGradientColors.add(params.mGradientEndColor)
                params.mPressedColor = a.getColor(R.styleable.AdvancedLinearLayout_pressed_color, 1)
                params.mBorderRadiusTopLeft = a.getDimensionPixelSize(
                    R.styleable.AdvancedLinearLayout_pressed_border_radius_top_left,
                    0
                )
                params.mBorderRadiusTopRight = a.getDimensionPixelSize(
                    R.styleable.AdvancedLinearLayout_pressed_border_radius_top_right,
                    0
                )
                params.mBorderRadiusBottomLeft = a.getDimensionPixelSize(
                    R.styleable.AdvancedLinearLayout_pressed_border_radius_bottom_left,
                    0
                )
                params.mBorderRadiusBottomRight = a.getDimensionPixelSize(
                    R.styleable.AdvancedLinearLayout_pressed_border_radius_bottom_right,
                    0
                )
                return params
            }
            ...
            private fun setRadii(params: AdvancedParams, a: TypedArray) {
                params.mBorderRadiusTopLeft =
                    a.getDimensionPixelSize(R.styleable.AdvancedLinearLayout_border_radius_top_left, 0)
                params.mBorderRadiusTopRight =
                    a.getDimensionPixelSize(R.styleable.AdvancedLinearLayout_border_radius_top_right, 0)
                params.mBorderRadiusBottomLeft = a.getDimensionPixelSize(
                    R.styleable.AdvancedLinearLayout_border_radius_bottom_left,
                    0
                )
                params.mBorderRadiusBottomRight = a.getDimensionPixelSize(
                    R.styleable.AdvancedLinearLayout_border_radius_bottom_right,
                    0
                )
            }
